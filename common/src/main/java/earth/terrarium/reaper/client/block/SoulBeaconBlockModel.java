...
public class SoulBeaconBlockModel extends AnimatedGeoModel<SoulBeaconBlockEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(Reaper.MOD_ID, "textures/block/soul_beacon.png");
    public static final ResourceLocation MODEL = new ResourceLocation(Reaper.MOD_ID, "geo/soul_beacon.geo.json");
    public static final ResourceLocation ANIMATION = new ResourceLocation(Reaper.MOD_ID, "animations/soul_beacon.animation.json");
